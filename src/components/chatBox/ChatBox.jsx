...
const ChatBox = () => {
  const { userData, messagesId, chatUser, setMessagesId, messages, setMessages, chatVisible, setChatVisible } =
  ...
  return chatUser ? (
    <div className={`chat-box ${chatVisible ? "" : "hidden"}`}>
      <div className="chat-user">
        ...
        <img className="arrow" onClick={()=>{setChatVisible(false)}} src={assets.arrow_icon} alt="" />
      </div>
      <div className="chat-msg">
        {messages.map((msg, index)=>(
           <div key={index} className={msg.sId === userData.id ? "s-msg" : "r-msg"}>
            {msg["image"] ? <img className="msg-img" src={msg.image} alt="" />:<p className="msg">{msg.type}</p>}
          <div>
